...
-- REMOVED in migration 0004 (2025-12-25): This index used deprecated status column
-- which is never updated. The VIEW calculates real status from timestamps.
-- Pre-check in generate.ts already handles duplicate prevention correctly.
